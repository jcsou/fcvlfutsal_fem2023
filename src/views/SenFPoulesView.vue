              ...
              <v-row>
                  <v-col>
                      <base-material-card color="colorPB" class="px-0"  >
                          <template v-slot:heading>
                              <div class="display-2 font-weight-light">SeniorF/U18F-PouleB-Matchs</div>
                          </template>
                          <v-card-text class="px-0" >
                  ...
                  <v-col>
                    <base-material-card color="colorPB" class="px-0"  >
                        <template v-slot:heading>
                            <div class="display-2 font-weight-light">SeniorF/U18F-PouleB-Classement</div>
                        </template>
                        <v-card-text class="px-0" >
...
export default {
    data() {
      return {
        ...
        urlPouleB: process.env.BASE_URL + "datas/F_c1_pouleB.json",
